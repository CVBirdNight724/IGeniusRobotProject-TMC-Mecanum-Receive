...
function Drive () {
    ...
    if (X == 2 && Y == 2 && button == 0) {
        ...
        control2(max_Speed, 0, max_Speed, 0)
    } else if (X == 4 && Y == 2) {
        control2(max_Speed, -1 * max_Speed, max_Speed, -1 * max_Speed)
    } else if (X == 3 && Y == 2) {
        control2(base_Speed, -1 * base_Speed, base_Speed, -1 * base_Speed)
    } else if (X == 3 && Y == 1) {
        control2(0, -1 * max_Speed, 0, -1 * max_Speed)
    } else if (X == 2 && Y == 0) {
        control2(-1 * max_Speed, -1 * max_Speed, -1 * max_Speed, -1 * max_Speed)
    } else if (X == 1 && Y == 1) {
        control2(-1 * max_Speed, 0, -1 * max_Speed, 0)
    } else if (X == 0 && Y == 2) {
        control2(-1 * max_Speed, max_Speed, -1 * max_Speed, max_Speed)
    } else if (X == 1 && Y == 2) {
        control2(base_Speed, -1 * base_Speed, base_Speed, -1 * base_Speed)
    } else if (X == 1 && Y == 3) {
        control2(0, max_Speed, 0, max_Speed)
    }
}
